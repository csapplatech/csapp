...
public function index()
{
    ...
    else if($User_model->isStudent()) //if it is a student 
    {
        ...
        else{} //tell the student that the advisor has yet to create a schedule.
    }
    else{} //You don't need to make a calendar          
}
...
}//end of Class appointment_controller extends CI_Controller
