<html>
    ...
    <body style="padding-top: 60px">
        ...
        <p> Welcome to the Advisor Main Page, <?php echo $user->getName(); ?>!</p>
        
        <button type="button">
            <?php echo "<li><a href='" .site_url('Activation'). "'>Activate New Advisee</a></li>";?>
        </button>
        <button type="button">
            <?php echo "<li><a href='" .site_url('Login/logout'). "'>Change Password</a></li>";?>
        </button>
        <button type="button">
            <?php echo "<li><a href='" .site_url('Login/logout'). "'>View Classes</a></li>";?>
        </button>
        <button type="button">
            <?php echo "<li><a href='" .site_url('Login/logout'). "'>View Advisees</a></li>";?>
        </button>
        <button type="button">
