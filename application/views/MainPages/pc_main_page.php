          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?php echo site_url('Calender'); ?>">Calender</a></li>
                <li class="active"><a href="<?php echo site_url('Courses'); ?>">Courses</a></li>
                <li class="active"><a href="<?php echo site_url('Advisors'); ?>">Advisors</a></li>
                <li class="active"><a href="<?php echo site_url('Students'); ?>">Students</a></li>
              </ul>
